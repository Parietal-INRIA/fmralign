...
project = u'fmralign'
copyright = u'The fmralign developers 2018-2019'
author = u'The fmralign developers'
...
latex_documents = [
    (master_doc, 'fmralign.tex', u'fmralign Documentation',
     u'T. Bazeille, B. Thirion', 'manual'),
]
...
man_pages = [
    (master_doc, 'fmralign', u'fmralign Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fmralign', u'fmralign Documentation',
     author, 'fmralign', 'One line description of project.',
     'Miscellaneous'),
]
