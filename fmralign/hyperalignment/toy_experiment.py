...
int1 = INT(latent_dim=latent_dim, decomp_method=decomposition_method, cache=False)
int2 = INT(latent_dim=latent_dim, decomp_method=decomposition_method, cache=False)
